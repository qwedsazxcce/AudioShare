...
+ Multi-channel & output APIs: pick Mono/2.1/4.0/5.1/7.1 layouts on Windows with automatic down/up mixing, and switch between AudioTrack, OpenSL ES or low-latency AAudio (preview) on Android depending on hardware and latency needs.
